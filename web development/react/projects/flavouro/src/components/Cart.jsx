...
const Cart = () => {
  ...
  const totalPrice = cartItems.reduce((total, item) => total + item.qty * item.price, 
  0);
  ...
  return (
    ...
    <div className={`fixed right-0 top-0 w-full lg:w-[20vw] p-5 h-full bg-white mb-3 ${activeCart ? "translate-x-0" : "translate-x-full" } transition-all duration-500 z-50`}>
       ...
       {cartItems.length > 0 ? ( cartItems.map((food) =>{
        ...
        <div className='absolute bottom-0'>
            ...
            className='bg-green-500 font-bold px-3 text-white py-2 rounded-lg lg:w-[17vw]  w-[90vw] mb-5'> Checkout </button>
